      ...
      <div className="tm_osn_divМатематика">
        <div className="task1_div">
            <div>
                ...
                <p className="task_p">Чему равна сумма углов в любом треугольнике?</p>
                <p className="task_p2">1) 90°</p>
                <p className="task_p2">2) 180°</p>
                <p className="task_p2">3) 270°</p>
                <p className="task_p2">4) 360°</p>
            </div>
