      ...
      <div className="tm_osn_divФизика">
        <div className="task1_div">
            <div>
                ...
                <p className="task_p">Какой закон Ньютона описывает зависимость ускорения от силы?</p>
                <p className="task_p2">1) Первый</p>
                <p className="task_p2">2) Второй</p>
                <p className="task_p2">3) Третий</p>
                <p className="task_p2">4) Закон всемирного тяготения</p>
            </div>
