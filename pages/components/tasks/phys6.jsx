    ...
    const Answerpr = () => {
        if (pr === 0) {
            ...
            if (answer === "2") {
                ...
                return(
                    <div>
                        <h1 className="task_h1">Не правильно, правильный ответ: 2</h1>
                        <Link href={`../${id}`} className="tasklink">Назад</Link> 
                    </div>
                )
            }
      ...
      <div className="tm_osn_divФизика">
        <div className="task1_div">
            <div>
                ...
                <p className="task_p">Если объем газа уменьшился в 2 раза при постоянной температуре, во сколько раз увеличилось его давление?</p>
            </div>
