    ...
    const Answerpr = () => {
        if (pr === 0) {
            ...
            if (answer === "10") {
                ...
                return(
                    <div>
                        <h1 className="task_h1">Не правильно, правильный ответ: 10</h1>
                        <Link href={`../${id}`} className="tasklink">Назад</Link> 
                    </div>
                )
            }
      ...
      <div className="tm_osn_divФизика">
        <div className="task1_div">
            <div>
                ...
                <p className="task_p">Тело массой 5 кг движется с ускорением 2 м/с². Чему равна результирующая сила?</p>
                <p className="task_p2">(Ответ укажи в Н)</p>
            </div>
