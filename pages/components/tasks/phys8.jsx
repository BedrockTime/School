      ...
      <div className="tm_osn_divФизика">
        <div className="task1_div">
            <div>
                ...
                <p className="task_p">Какой параметр остается постоянным в изобарном процессе?</p>
                <p className="task_p2">1) Температура</p>
                <p className="task_p2">2) Объем</p>
                <p className="task_p2">3) Давление</p>
                <p className="task_p2">4) Энергия</p>
            </div>
