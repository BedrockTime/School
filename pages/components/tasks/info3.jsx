      ...
      <div className="tm_osn_divИнформатика">
        <div className="task1_div">
            <div>
                ...
                <p className="task_p">Какой тип алгоритма описывает последовательное выполнение действий без ветвлений и повторений?</p>
                <p className="task_p2">1) Линейный</p>
                <p className="task_p2">2) Циклический</p>
                <p className="task_p2">3) Разветвляющийся</p>
                <p className="task_p2">4) Рекурсивный</p>
            </div>
