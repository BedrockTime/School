    ...
    const Answerpr = () => {
        if (pr === 0) {
            ...
            if (answer === "2") {
                ...
                return(
                    <div>
                        <h1 className="task_h1">Не правильно, правильный ответ под номером: 2</h1>
                        <Link href={`../${id}`} className="tasklink">Назад</Link> 
                    </div>
                )
            }
      ...
      <div className="tm_osn_divФизика">
        <div className="task1_div">
            <div>
                ...
                <p className="task_p">Если тело движется равномерно и прямолинейно, то что можно сказать о действующих на него силах?</p>
                <p className="task_p2">1) Их нет</p>
                <p className="task_p2">2) Они скомпенсированы</p>
                <p className="task_p2">3) Они увеличиваются</p>
                <p className="task_p2">4) Они уменьшаются</p>
            </div>
