...
const Task5 = () => {
    ...
    const Answerpr = () => {
        if (pr === 0) {
            ...
            if (answer.toLowerCase() === "дизъюнкция") {
                ...
                return(
                    <div>
                        <h1 className="task_h1">Не правильно, правильный ответ: Дизъюнкция</h1>
                        <Link href={`../${id}`} className="tasklink">Назад</Link> 
                    </div>
                )
            }
      ...
      <div className="tm_osn_divИнформатика">
        <div className="task1_div">
            <div>
                ...
                <p className="task_p">Какая логическая операция соответствует союзу "ИЛИ" в программировании?</p>
            </div>
