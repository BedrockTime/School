    ...
    const Answerpr = () => {
        if (pr === 0) {
            ...
            if (answer.toLowerCase() === "трение") {
                ...
                return(
                    <div>
                        <h1 className="task_h1">Не правильно, правильный ответ: трение</h1>
                        <Link href={`../${id}`} className="tasklink">Назад</Link> 
                    </div>
                )
            }
      ...
      <div className="tm_osn_divФизика">
        <div className="task1_div">
            <div>
                ...
                <p className="task_p">Как называется сила, которая сопротивляется движению тела по поверхности?</p>
            </div>
