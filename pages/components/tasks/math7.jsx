      ...
      <div className="tm_osn_divМатематика">
        <div className="task1_div">
            <div>
                ...
                <p className="task_p">Какой теореме подчиняется соотношение сторон в прямоугольном треугольнике?</p>
                <p className="task_p2">1) Теорема косинусов</p>
                <p className="task_p2">2) Теорема синусов</p>
                <p className="task_p2">3) Теорема Пифагора</p>
                <p className="task_p2">4) Теорема Виета</p>
            </div>
