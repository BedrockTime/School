                ...
                <div className="works_text_div">
                    <div className="works_text_part" onMouseOver={() => setImg("https://thumb.cloud.mail.ru/weblink/thumb/xw1/r9Bi/dD5vJCDAC")}>
                        ...
                        <div className="works_numtext">
                            ...
                            <h1 className="works_h1">Подготовьте и загрузите свои задания в любую комнату</h1>
                        </div>
                        <p className="works_p">Загружайте как графические, так и текстовые задания в бесплатные квест-комнаты.</p>
                    </div>
                    <div className="works_text_part" onMouseOver={() => setImg("https://thumb.cloud.mail.ru/weblink/thumb/xw1/WbJY/wLurHg4yK")}>
                        ...
                        <p className="works_p">Результаты учеников автоматически запишутся в ваш личный кабинет в карточку с квестом. Нажмите по кнопке «Статистика», чтобы увидеть их.</p>
                    </div>
                </div>
